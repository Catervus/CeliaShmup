...
IncludeDirs["Pond"] = "%{prj.name}/vendor/Pond/include"
...
project "CeliaShmup"
	...
	postbuildcommands
	{
			...
			-- Pond
			("{COPY} ../dependencies/Pond/lib/x64/Pond.dll $(OutDir)"),
			("{COPY} ../dependencies/Pond/lib/x64/Pond.lib $(OutDir)"),
